...
void loop() {
  ...
  Serial2.println("write 0xAA to address 0x02 0x02");
  N24C32_byte_write(0x02, 0x02, 0xAA);
  delay(500);
  Serial2.println("write 0xBB to address 0x02 0x03");
  N24C32_byte_write(0x02, 0x03, 0xBB);
  delay(500);
  Serial2.println("write 0xCC to address 0x13 0x09");
  N24C32_byte_write(0x13, 0x09, 0xCC);
